  ...
  <div class="container-xxl py-5">
    <div class="container">
      <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
        <div class="col-lg-6">
          <p><span class="text-primary me-2">#</span>My Services</p>
          <h1 class="display-5 mb-0">
            You have registered for following services at
            <span class="text-primary">DOA</span>
          </h1>
        </div>
        <div class="col-lg-6 text-lg-end">
          <a class="btn btn-primary py-3 px-5" href="/services">Back to Services</a>
        </div>
      </div>
      <div class="row g-4">
