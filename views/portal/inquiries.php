      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Inquiries</h4>
            <div class="card">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php foreach($inquiries as $inquiry): ?>
                              <tr>
                              <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $inquiry->getName(); ?></strong></td>
